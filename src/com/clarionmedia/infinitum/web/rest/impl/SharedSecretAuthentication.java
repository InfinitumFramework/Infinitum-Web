...
public class SharedSecretAuthentication implements AuthenticationStrategy {
     ...
     * used.
     *
     * @param tokenName the token name to use for authentication
     */
     ...
     *
     * @param token the shared secret to use for authentication
     */
     ...
     *
     * @param generator the {@code TokenGenerator} to register
     */
