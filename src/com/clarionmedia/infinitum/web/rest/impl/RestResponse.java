...
public class RestResponse implements HttpClientResponse {
     ...
     * Constructs a new {@code RestResponse}.
     *
     * @param httpResponse the {@link HttpResponse} to wrap
     */
     ...
     *
     * @param responseData the message data byte array to set
     */
     ...
     *
     * @param responseDataStr the message data {@code String} to set
     */
